...
`
  ...
  create() {
    ...
    const baseShader1 = new Phaser.Display.BaseShader("BufferShader1", this.fragmentShader())
    const baseShader2 = new Phaser.Display.BaseShader("BufferShader2", this.fragmentShader5())
    const baseShader3 = new Phaser.Display.BaseShader("BufferShader3", this.fragmentShader7())
    const baseShader4 = new Phaser.Display.BaseShader("BufferShader4", this.fragmentShader3())
    const baseShader5 = new Phaser.Display.BaseShader("BufferShader4", this.fragmentShader4())
