...
import { UIScene, WorldScene } from "../../components/camera/worldCoordinateFromAnotherScene"

let myCanvas = ref(null)
let canvasBox = ref(null)
let game
let uiScene, worldScene
let text = ref("")
...
onMounted(() => {
  ...
  uiScene = new UIScene(canvasBox.value.clientWidth, canvasBox.value.clientHeight, changeText)
  worldScene = new WorldScene(canvasBox.value.clientWidth, canvasBox.value.clientHeight, changeText)
  let config = {
    type: Phaser.AUTO,
