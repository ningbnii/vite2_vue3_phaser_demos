...
import { MapScene, UIScene } from "../../components/camera/crossSceneObjectPlacement"

let myCanvas = ref(null)
let canvasBox = ref(null)
let game
let mapScene, uiScene
let text = ref("")
...
onMounted(() => {
  ...
  mapScene = new MapScene(canvasBox.value.clientWidth, canvasBox.value.clientHeight, changeText)
  uiScene = new UIScene()
  let config = {
    type: Phaser.AUTO,
    scale: {
